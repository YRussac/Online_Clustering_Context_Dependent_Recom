def G_CLUB_general(T, alpha, alpha_2, n_users, n_products, d_large, embedding_param = None,
                 ...
                 method_products= 'One-Hot', beta= 20,seed=None):
    ...
    - beta: parameter used for the updating of the proxy of the products
    ...
    if embedding_param:
        ...
        generation_data = generate_embedded_data(T, T_historical, n_users, n_products, d, d_reduced, method_users,
                                                 method_products, n_class_products, n_class_users,
                                                 context_len, context_emb, emb_noise, plot_emb,
    ...
    for t in range(T):
        ...
        products[item_propos, :] = products[item_propos, :] + beta * a_t * np.mean(CB[j_t, :]) * \
                                                              w_matrix[i_t].reshape(products[item_propos, :].shape)
        products[item_propos, :] = products[item_propos, :]/np.sum(products[item_propos, :]**2)
